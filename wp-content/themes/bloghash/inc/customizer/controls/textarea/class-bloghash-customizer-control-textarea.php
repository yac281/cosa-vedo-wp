<?php
/**
 * Bloghash Customizer custom textarea control class.
 *
 * @package     Bloghash
...
if ( ! class_exists( 'Bloghash_Customizer_Control_Textarea' ) ) :
	/**
	 * Bloghash Customizer custom select control class.
	 */
	class Bloghash_Customizer_Control_Textarea extends Bloghash_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="bloghash-control-wrapper bloghash-textarea-wrapper">
