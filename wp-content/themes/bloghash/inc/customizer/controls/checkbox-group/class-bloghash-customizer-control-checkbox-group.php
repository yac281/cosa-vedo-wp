<?php
/**
 * Bloghash Customizer checkbox group control class.
 *
 * @package     Bloghash
...
if ( ! class_exists( 'Bloghash_Customizer_Control_Checkbox_Group' ) ) :
	/**
	 * Bloghash Customizer checkbox group control class.
	 */
	class Bloghash_Customizer_Control_Checkbox_Group extends Bloghash_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'bloghash-checkbox-group';
		...
		protected function content_template() {
			?>
			<div class="bloghash-checkbox-group-wrapper bloghash-control-wrapper">
							...
							<label class="bloghash-checkbox">
								...
								<span class="bloghash-label">{{ params.title }}
									...
									<i class="bloghash-info-icon">
										...
										<span class="bloghash-tooltip">{{ params.desc }}</span>
									</i>
									<# } #>
								</span>
							</label>
			...
			</div><!-- END .bloghash-button-wrapper -->
			<?php
		}
