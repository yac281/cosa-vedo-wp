<?php
/**
 * Bloghash Customizer custom text control class.
 *
 * @package     Bloghash
...
if ( ! class_exists( 'Bloghash_Customizer_Control_Datetime' ) ) :
	/**
	 * Bloghash Customizer custom select control class.
	 */
	class Bloghash_Customizer_Control_Datetime extends Bloghash_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="bloghash-control-wrapper bloghash-text-wrapper">
				...
				<label>
					...
					<div class="bloghash-info-text">{{{ data.info }}}</div>
				</label>
