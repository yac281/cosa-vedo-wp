...
/**
 * Bloghash Customizer editor control class.
 */
class Bloghash_Customizer_Control_Editor extends Bloghash_Customizer_Control {
	/**
	...
	protected function content_template() {
		?>
		<div class="bloghash-control-wrapper wp-js-editor bloghash-textarea-wrapper">
			<label>
				<# if ( data.label ) { #>
