...
if ( ! class_exists( 'Bloghash_Customizer_Widget_Search' ) ) :

	/**
	 * Bloghash Customizer widget class
	 */
	class Bloghash_Customizer_Widget_Search extends Bloghash_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Search', 'bloghash' );
			$this->description = __( 'A search form for your site.', 'bloghash' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="bloghash-widget-search-style">
