...
if ( ! class_exists( 'Bloghash_Jetpack' ) ) :
	/**
	 * Jetpack compatibility class.
	 */
	class Bloghash_Jetpack {
		...
		public function tweak_credits_link() {
			return '<a href="https://wordpress.org/" rel="noopener noreferrer" target="_blank">' . esc_html__( 'Proudly powered by WordPress', 'bloghash' ) . '</a> | <a href="https://peregrine-themes.com/" rel="noopener noreferrer" target="_blank">Peregrine Themes</a>';
		}
		...
		public function filter_infinite_scroll_js_settings( $settings ) {
			...
			$settings['text'] = esc_html__( 'Load More', 'bloghash' );
